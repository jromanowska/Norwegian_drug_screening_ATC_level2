...
bscols(widths = c(3, NA),
	...
	plot_ly(data = shared.atc, x = ~HR, y = ~ATC_code, text = ~hover.text,
					 error_x = list(
...
```{r plot_ggplotly, eval=TRUE, include=TRUE, echo=FALSE, warning=FALSE, out.height=1200, fig.height=100}
# create two columns: one for selection, the other for plot
shared.atc <- SharedData$new(cur.results)
...
```{r plot_ggplotly,include=TRUE,echo=FALSE,warning=FALSE,out.height=1200,fig.height=100}
```
